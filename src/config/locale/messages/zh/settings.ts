export default {
  ...
  memoryEnabled: '启用记忆',
  memoryEnabledDescription: '在 Agent 请求中注入短期会话摘要和已确认的长期记忆',
  longTermMemoryEnabled: '启用长期记忆',
  longTermMemoryEnabledDescription:
    '跨会话召回稳定偏好、决策、事实和工作流约束',
  memoryAutoSaveMode: '长期记忆保存模式',
  memoryAutoSaveOff: '关闭',
  memoryAutoSaveExplicit: '仅显式记住',
  memoryAutoSaveSuggest: '需要确认',
  maxMemoryContextTokens: '记忆上下文 Token',
  maxMemoryContextTokensDescription: '每次请求注入记忆的最大 Token 预算',
  maxLongTermMemoryItems: '长期记忆条数',
  maxLongTermMemoryItemsDescription: '每次请求最多召回的长期记忆数量',
...
// HTTP 示例:
{
  ...
  dataExportDescription:
    '将所有任务、消息、设置和 Agent 记忆导出为 JSON 文件。',
  dataExportButton: '导出',
  dataExporting: '导出中...',
  dataImport: '导入数据',
  ...
  dataClearTasksOnlyDescription: '删除所有任务、消息和会话记忆，保留设置',
  dataClearSettingsOnly: '仅清空配置',
  dataClearSettingsOnlyDescription: '重置所有配置为默认值，保留任务',
  dataClearAll: '清空所有数据',
  dataClearAllDescription: '删除所有任务、消息、设置和 Agent 记忆',
  dataClearTasksConfirm:
    '确定要删除所有任务、消息和会话记忆吗？此操作无法撤销。',
  dataClearSettingsConfirm: '确定要将所有配置重置为默认值吗？此操作无法撤销。',
  dataClearAllConfirm:
    '确定要删除所有数据（包括任务、消息、设置和 Agent 记忆）吗？此操作无法撤销。',
  dataConfirmTitle: '确认',
